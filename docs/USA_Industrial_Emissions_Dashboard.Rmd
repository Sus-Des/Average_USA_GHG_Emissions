---
title: "Industrial Emmissions Tracked by The EPA's GHGR Program"
output: 
...
USA_Emissions_State$Total_Emissions <-  format(USA_Emissions_State$`Total reported direct emissions`, big.mark = ",", scientific = FALSE) 
...
state_emissions <- ggplot(USA_Emissions_State, aes(fct_reorder(State, `Total reported direct emissions`),
                                                   ...
                                                   text = paste0("<b>State:", State, "<br>",
                                                                 "<b> Repoted Emissions: ",  format(USA_Emissions_State$`Total reported direct emissions`, big.mark=","),"<br>",
                                                                 "<b> Carbon:",sprintf("%10.2f", round( (`CO2 emissions (non-biogenic)`/Total_Emissions)*100, digits = 2)), "%","<br>",
                                                                 "<b> Methane:",sprintf("%10.2f", round( (`Methane (CH4) emissions`/Total_Emissions)*100, digits = 2)), "%","<br>",
                                                                 "<b> Nitrous Oxide:",sprintf("%10.2f", round( (`Nitrous Oxide (N2O) emissions`/Total_Emissions)*100, digits = 2)), "%","<br>")))+
  geom_point()+
  coord_flip()+
  labs(y = "GHG Emissions in CO2e", x = "State", title = "Average Annually Reported Industrial Emissions")+
