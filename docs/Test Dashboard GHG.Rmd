...
state_emissions <- ggplot(USA_Emissions_State, aes(fct_reorder(State, `Total reported direct emissions`),
                                                   ...
                                                   text = paste0("<b>State:", State, "<br>",
                                                                 "<b> Total repoted direct emissions:",  format(USA_Emissions_State$`Total reported direct emissions`, big.mark=","),"<br>",
  ...
  geom_point()+
  coord_flip()+
  labs(y = "GHG Emissions in CO2e", x = "State", title = "Total Reported Direct Emissions")+
